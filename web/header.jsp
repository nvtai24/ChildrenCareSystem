            ...
            <div class="sticky-header navbar-expand-lg">
                <div class="menu-bar clearfix">
                    <div class="container clearfix">
                        <!-- Header Logo ==== -->
                        <div class="menu-logo">
                            <a href="/app"><img src="assets/images/logo.png" /></a>
                        </div>
                        ...
                        <div
                            ...
                            <ul class="nav navbar-nav">
                                ...
                                <c:if
                                    test="${sessionScope.account.role.id == 12 || sessionScope.account.role.id == 14 || sessionScope.account.role.id == 16 }"
                                    >
                                ...
                                <c:if
                                    ...
                                    >
                                    <li><a href="reservations">Dashboard</a></li>
                                    </c:if>
                            </ul>
                                ...
                                <c:if test="${sessionScope.account != null}">
                                    <li class="nav-item dropdown">
                                        <a
                                            ...
                                            >
                                            <img id="userAvatar"
                                                 src="${sessionScope.account.profile.avatar != null ?
                                                        sessionScope.account.profile.avatar :
                                                        "assets/images/profile/default.jpg"}" alt="User Avatar"
                                    ...
                                    <c:if
                                        test="${sessionScope.account != null && sessionScope.account.role.id == 15  || sessionScope.account.role.id == 16}"
                                        >
                                        <li class="nav-item">
                                            <a
                                                class="nav-link"
                                                href="reservation/detail"
                                                style="color: black"
                                                >
                                                <i
