                            ...
                            <c:if test="${sessionScope.account != null}" >
                                ...
                                <li class="nav-item dropdown">
                                    <a class="nav-link d-flex align-items-center" href="#" id="userAvatar" role="button" data-bs-toggle="dropdown" aria-expanded="false" style="display: flex; align-items: center;">
                                        <img src="${sessionScope.account.profile.avatar}" alt="User Avatar" width="32px" height="32px" class="rounded-circle" style="border-radius: 50%; width: 40px; height: 40px; object-fit: cover;">
                                    </a>
                                    <ul class="dropdown-menu dropdown-menu-end shadow" aria-labelledby="userAvatar">
                                        <li data-bs-toggle="modal" data-bs-target="#profileModal"><a class="dropdown-item" style="color: black;">Edit Profile</a></li>
