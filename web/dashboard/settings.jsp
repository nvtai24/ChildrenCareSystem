    ...
    <main class="ttr-wrapper">
      <div class="container-fluid">
        ...
        <table id="settingsTable" class="table table-hover">
          ...
          <tbody>
            <c:forEach
              items="${requestScope.settings}"
              var="s"
              varStatus="status"
            >
              <tr>
                <th scope="row" class="align-middle">${status.index + 1}</th>
                <td class="align-middle">${s.settingValue}</td>
                <td class="align-middle">${s.settingType.name}</td>
                <td class="align-middle">${s.description}</td>
                <td class="align-middle" id="badge">
                  <c:choose>
                ...
                <td
                  class="align-middle text-center d-flex justify-content-center align-items-center"
                >
                  <div
                    class="status-toggle mr-2"
                    data-id="${s.id}"
                    data-status="${s.status}"
                  >
                    <c:choose>
                      <c:when test="${s.status}">
                        <button class="btn red mb-2" style="width: 100px">
                          <i class="fa fa-refresh" aria-hidden="true"></i>
                          Inactive
                        </button>
                      </c:when>
                      <c:otherwise>
                        <button class="btn green mb-2" style="width: 100px">
                          <i class="fa fa-refresh" aria-hidden="true"></i>
                          Active
                        </button>
                      </c:otherwise>
