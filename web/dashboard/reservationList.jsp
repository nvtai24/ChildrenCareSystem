    ...
    <body class="ttr-opened-sidebar ttr-pinned-sidebar">
        ...
        <main class="ttr-wrapper">
            <div class="container-fluid">
                ...
                <table id="reservationTable" class="table table-striped table-hover" style="width:100%">
                    ...
                    <tbody>
                        <c:forEach items="${requestScope.reservations}" var="r" varStatus="status">
                            <tr>
                                <td>${status.index + 1}</td>
                                <td>${r.firstName}</td>
                                <td>${r.lastName}</td>
                                <td>${r.reverseDate.toLocalTime()} ${r.reverseDate.toLocalDate()}</td>                        
                                <td>${r.phone}</td>
                                <td>${r.email}</td>
