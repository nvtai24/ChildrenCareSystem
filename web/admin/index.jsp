<%-- 
    Document   : index
    Created on : Jan 23, 2025, 1:10:43 AM
    Author     : Nvtai
--%>
                ...
                <div class="ttr-logo-box">
                    <div>
                        <a href="index.html" class="ttr-logo">
                            <img class="ttr-logo-mobile" alt="" src="assets2/images/logo-mobile.png" width="30" height="30">
                            <img class="ttr-logo-desktop" alt="" src="assets2/images/logo-white.png" width="160" height="27">
                        </a>
                    </div>
                </div>
                <!--logo end -->
                                    ...
                                    <ul>
                                        <li>
                                            <span class="new-users-pic">
                                                <img src="assets2/images/testimonials/pic1.jpg" alt=""/>
                                            </span>
                                        ...
                                        <li>
                                            <span class="new-users-pic">
                                                <img src="assets2/images/testimonials/pic2.jpg" alt=""/>
                                            </span>
                                            <span class="new-users-text">
